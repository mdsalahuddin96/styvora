      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        ...
        <div className="mb-14 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-gray-500">
            Discover our most loved pieces, carefully selected to bring elegance,
            confidence and timeless fashion into your wardrobe.
          </p>
        </div>
        ...
        <div className="mt-14 text-center">
          ...
          <Link href={"/products"} className="rounded-full bg-gradient-to-r from-[#111111] to-[#C98A5D] px-10 py-4 font-semibold text-white">
            View All Products
          </Link>
